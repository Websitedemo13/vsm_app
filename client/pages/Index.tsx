...
import { Play, Users, MapPin, Calendar, Star, ArrowRight, CheckCircle } from "lucide-react";
      ...
      {Object.entries(timeLeft).map(([unit, value]) => (
        <div key={unit} className="text-center">
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 md:p-6 min-w-[80px] md:min-w-[100px]">
            ...
            <div className="text-white/80 text-sm md:text-base uppercase tracking-wide">{unit}</div>
          </div>
        </div>
      ))}
    </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
              ...
              Theo dõi tiến độ, tham gia thử thách và kết nối với hàng nghìn sinh viên cùng đam mê.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Button size="lg" className="bg-white text-vsm-orange hover:bg-gray-50 text-lg px-8 py-4">
                <Play className="w-6 h-6 mr-2 fill-current" />
                Bắt đầu chạy ngay
              </Button>
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-vsm-orange text-lg px-8 py-4">
            ...
            {/* Countdown Timer */}
            <div className="mb-8">
              <h3 className="text-2xl font-semibold text-white mb-6">Marathon chính thức bắt đầu sau:</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-vsm-black mb-6">
                ...
                <span className="block text-vsm-orange">Kết nối đam mê chạy bộ</span>
              </h2>
              
              <p className="text-lg text-vsm-gray-medium mb-8 leading-relaxed">
                VSM là nền tảng hàng đầu tại Việt Nam dành riêng cho sinh viên yêu thích chạy bộ. 
                Chúng tôi tin rằng thể thao không chỉ giúp rèn luyện sức khỏe mà còn xây dựng 
                tinh thần đoàn kết và kỷ luật trong học tập.
              </p>
              ...
              <div className="aspect-square bg-gradient-to-br from-vsm-orange/20 to-vsm-orange/40 rounded-3xl p-8">
                <div className="w-full h-full bg-white/50 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-vsm-black font-semibold">Hình ảnh sinh viên chạy bộ</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-vsm-gray-medium max-w-2xl mx-auto">
              Hàng nghìn sinh viên đã tin tướng và đồng hành cùng VSM trong hành trình rèn luyện sức khỏe
            </p>
          </div>
              ...
              <Card key={index} className="text-center p-6 hover:shadow-lg transition-shadow">
                <CardContent className="pt-6">
                  <div className="text-3xl md:text-4xl font-bold text-vsm-orange mb-2">
                    {stat.number.includes('.') ? stat.number : stat.number.slice(0, -3)}
      ...
      <section className="py-20 md:py-32 vsm-gradient relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Tải ứng dụng VSM ngay hôm nay và bắt đầu hành trình chạy bộ cùng hàng nghìn sinh viên khắp Việt Nam
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-vsm-orange transition-colors">Ứng dụng mobile</a></li>
                <li><a href="#" className="hover:text-vsm-orange transition-colors">Theo dõi GPS</a></li>
                <li><a href="#" className="hover:text-vsm-orange transition-colors">Cộng đồng</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-vsm-orange transition-colors">Trung tâm trợ giúp</a></li>
                <li><a href="#" className="hover:text-vsm-orange transition-colors">Liên hệ</a></li>
                <li><a href="#" className="hover:text-vsm-orange transition-colors">FAQ</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-vsm-orange transition-colors">Facebook</a></li>
                <li><a href="#" className="hover:text-vsm-orange transition-colors">Instagram</a></li>
                <li><a href="#" className="hover:text-vsm-orange transition-colors">TikTok</a></li>
              </ul>
            </div>
          </div>
