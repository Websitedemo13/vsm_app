  ...
  const communityGroups: CommunityGroup[] = [
    {
      ...
      description:
        "Cộng đồng chạy bộ sinh viên Đại học Bách Khoa Hà Nội. Tham gia để kết nối với bạn bè cùng trường và tham gia các hoạt động chạy bộ hàng tuần.",
      members: 2847,
      avatar: "🎓",
      category: "university",
      isJoined: true,
    ...
    },
    {
      ...
      description:
        "Nhóm dành cho sinh viên các trường đại học tại TP.HCM. Chạy bộ khám phá Sài Gòn và tham gia các sự kiện lớn.",
      members: 4521,
      avatar: "🌃",
      category: "location",
      isJoined: false,
    ...
    },
    {
      ...
      description:
        "Dành cho những người mới bắt đầu chạy bộ. Hỗ trợ, động viên và hướng dẫn từ cộng đồng thân thiện.",
      members: 8934,
      avatar: "🌱",
      category: "level",
      isJoined: false,
    ...
    },
    {
      ...
      description:
        "Nhóm chuẩn bị cho VSM Marathon 2025. Chia sẻ kinh nghiệm, kế hoạch tập luyện và động viên lẫn nhau.",
      members: 1256,
      avatar: "🏃‍♂️",
      category: "interest",
      isJoined: true,
    ...
    },
    {
      ...
      description:
        "Dành cho những người thích chạy bộ vào buổi sáng sớm. Thức dậy cùng nhau và bắt đầu ngày mới với năng lượng tích cực!",
      members: 672,
      avatar: "🌅",
      category: "interest",
      isJoined: false,
    ...
    },
    {
      ...
      description:
        "Nhóm riêng cho những runner có thành tích xuất sắc. Yêu cầu pace dưới 4:30/km để tham gia.",
      members: 89,
      avatar: "⚡",
      category: "level",
      isJoined: false,
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <Badge
                      key={tag}
                      variant="outline"
                      className="text-xs hover:bg-purple-50 cursor-pointer"
                    >
                      {tag}
                    </Badge>
                  ))}
        ...
        <Card className="mt-12 bg-gradient-to-r from-purple-600 to-blue-600 text-white border-0">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              Kết nối với hàng nghìn sinh viên cùng đam mê, chia sẻ kinh nghiệm
              và cùng nhau tiến bộ trong hành trình chạy bộ
            </p>
