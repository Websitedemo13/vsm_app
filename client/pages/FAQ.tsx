  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer: "VSM (Vietnam Student Marathon) là nền tảng chạy bộ dành riêng cho sinh viên Việt Nam. Mọi sinh viên đang học tại các trường đại học, cao đẳng trên toàn quốc đều có thể tham gia. Ứng dụng giúp kết nối cộng đồng chạy bộ sinh viên, theo dõi hoạt động với GPS, tham gia các sự kiện và thử thách.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl opacity-90 mb-8">
              Tìm câu trả lời nhanh chóng cho các vấn đề phổ biến khi sử dụng VSM
            </p>
                ...
                {popularFAQs.map((faq) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-500">
                      ...
                      <Badge variant="secondary">{categories.find(c => c.id === faq.category)?.title}</Badge>
                    </div>
                  </div>
                ))}
              </div>
                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-4 text-sm text-gray-500">
                              <span>{categories.find(c => c.id === faq.category)?.title}</span>
                              <div className="flex items-center space-x-1">
                                <ThumbsUp className="w-4 h-4" />
                                <span>{faq.helpful}</span>
                              </div>
                        ...
                        <div className="px-6 pb-6 border-t bg-gray-50">
                          <div className="pt-6">
                            ...
                            <div className="mt-6 pt-4 border-t border-gray-200">
                              <p className="text-sm text-gray-600 mb-3">Câu trả lời này có hữu ích không?</p>
                              <div className="flex items-center space-x-4">
                                <Button
                                  size="sm"
                                  variant={userFeedback[faq.id] === 'helpful' ? "default" : "outline"}
                                  onClick={() => handleFeedback(faq.id, 'helpful')}
                                  className={userFeedback[faq.id] === 'helpful' ? "bg-green-600 hover:bg-green-700" : ""}
                                >
                                ...
                                <Button
                                  ...
                                  className={userFeedback[faq.id] === 'not-helpful' ? "bg-red-600 hover:bg-red-700" : ""}
                                >
