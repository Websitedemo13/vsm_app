...
export default function News() {
  const articles = [
    {
      ...
      excerpt: "Sự kiện marathon lớn nhất năm đã thu hút số lượng kỷ lục sinh viên từ khắp cả nước...",
      image: "📸",
      author: "VSM Team",
      date: "2024-12-10",
      category: "Sự kiện",
    ...
    },
    {
      ...
      excerpt: "Làm thế nào để duy trì thói quen chạy bộ khi bạn có lịch học dày đặc? Đây là những bí quyết...",
      image: "🏃‍♂️",
      author: "Coach Minh",
      date: "2024-12-08",
    ...
    },
    {
      ...
      excerpt: "Hơn 500 sinh viên đã cùng nhau chạy bộ gây quỹ hỗ trợ trẻ em vùng cao...",
      image: "❤️",
      author: "VSM HCM",
      date: "2024-12-05",
      category: "Tin tức",
    ...
    },
    {
      ...
      excerpt: "Phiên bản mới của ứng dụng VSM đã tích hợp công nghệ AI để theo dõi nhịp tim chính xác...",
      image: "📱",
      author: "Tech Team",
      date: "2024-12-03",
      category: "Công nghệ",
  ...
  const categories = ["Tất cả", "Tin tức", "Sự kiện", "Tips chạy bộ", "Công nghệ"];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-lg text-vsm-gray-medium max-w-2xl mx-auto">
              Cập nhật những thông tin mới nhất về cộng đồng chạy bộ sinh viên và các sự kiện sắp tới
            </p>
          </div>
        </div>
      </div>
            ...
            <Card key={article.id} className="overflow-hidden hover:shadow-lg transition-shadow group">
              ...
              <CardHeader className="pb-4">
                <div className="flex items-center justify-between mb-2">
                  <Badge variant="secondary" className="bg-vsm-orange/10 text-vsm-orange">
                    {article.category}
                  </Badge>
