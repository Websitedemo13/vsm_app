...
export default function Segments() {
  ...
  const loadSegments = () => {
    const mockSegments: Segment[] = [
      ...
      },
      {
        ...
        description:
          "Thử thách qua cầu Long Biên lịch sử - gió mạnh và view tuyệt đẹp",
        distance: 2.4,
        elevation: 35,
        location: "Hà Nội, Việt Nam",
        difficulty: "extreme",
  ...
  const filteredSegments = segments.filter(
    (segment) => filter === "all" || segment.category === filter,
  );
                          ...
                          <div className="flex items-start justify-between mb-4">
                            <div className="flex-1">
                              <div className="flex items-center space-x-3 mb-2">
                                <h3 className="text-xl font-bold text-vsm-black">
                                  {segment.name}
                                </h3>
                                <Badge
                              ...
                              <div className="flex items-center space-x-6 text-sm text-gray-600">
                                ...
                                <div className="flex items-center space-x-1">
                                  ...
                                  <span>
                                    {segment.attempts.toLocaleString()} lượt thử
                                  </span>
                                </div>
                              </div>
                                  ...
                                  <div className="flex items-center justify-between">
                                    ...
                                    <div className="text-right">
                                      <div className="text-sm text-blue-600">
                                        Hạng {segment.personalBest.rank}
                                      </div>
                                      <div className="text-xs text-gray-500">
                                        {segment.personalBest.date}
                                      </div>
                                    </div>
                                  </div>
                                </div>
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-xs text-gray-500 truncate">
                                {entry.athlete.university}
                              </p>
                            </div>

                            <div className="text-right">
                              <div className="text-sm font-bold text-vsm-black">
                                {entry.time}
                              </div>
                              <div className="text-xs text-gray-500">
                                {entry.pace}/km
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-600 mb-2">
                  Chưa có segment cá nhân
                </h3>
                <p className="text-gray-500 mb-6">
                  Bắt đầu chạy để khám phá các segment và xây dựng kỷ lục cá
                  nhân của bạn!
                </p>
                <Button className="bg-vsm-orange hover:bg-vsm-orange-dark text-white">
          ...
          <TabsContent value="nearby" className="space-y-6">
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-600 mb-2">
                  Đang tìm segment gần bạn
                </h3>
                <p className="text-gray-500 mb-6">
                  Cho phép truy cập vị trí để tìm các segment thú vị quanh khu
                  vực của bạn
                </p>
                <Button className="bg-vsm-orange hover:bg-vsm-orange-dark text-white">
